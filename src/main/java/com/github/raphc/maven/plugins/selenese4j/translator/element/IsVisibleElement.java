...
/**
 * @author Raphael
 * Genere l'instruction Java correspondant à la commande isVisible
 */
@WebDriverElement
public class IsVisibleElement implements Element  {
	...
	public String process(Command command) throws IllegalArgumentException {
		return "driver.findElement("+LocatorResolver.resolve(command.getTarget())+").isDisplayed()";
	}
